...
export const skills = [
  {
    group: 'Languages',
    items: ['JavaScript (ES6+)', 'TypeScript', 'HTML5', 'CSS3', 'JSX'],
  },
  {
    group: 'Frontend',
    items: [
  ...
  },
  {
    ...
    items: ['Redux Toolkit', 'RTK Query', 'Redux Saga', 'Zustand', 'Redux Persist', 'Context API'],
  },
  {
  ...
  {
    group: 'Backend & APIs',
    items: ['REST APIs', 'Node.js', 'Axios', 'JWT Auth', 'React Hook Form'],
  },
  {
    group: 'Reporting & Data',
    items: ['jsPDF', 'html2canvas', 'XLSX', 'Highcharts', 'MUI X Data Grid'],
  },
  {
    group: 'Tools & Quality',
    items: ['Git', 'GitHub', 'Jest', 'ESLint', 'Postman', 'Figma', 'JIRA', 'Agile/Scrum', 'Vite'],
  },
]
